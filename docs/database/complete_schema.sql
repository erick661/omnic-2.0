...
\restrict UbaeMbvZcEm1tYrDv6Qv42ttebsuP1lD0QbCTcHngMyXofoutrmMPxTUGn2vod4
...
ALTER TABLE IF EXISTS ONLY public.user_roles DROP CONSTRAINT IF EXISTS user_roles_user_id_foreign;
ALTER TABLE IF EXISTS ONLY public.reference_codes DROP CONSTRAINT IF EXISTS reference_codes_case_id_foreign;
ALTER TABLE IF EXISTS ONLY public.reference_codes DROP CONSTRAINT IF EXISTS reference_codes_assigned_user_id_foreign;
ALTER TABLE IF EXISTS ONLY public.phone_communications DROP CONSTRAINT IF EXISTS phone_communications_communication_id_foreign;
ALTER TABLE IF EXISTS ONLY public.outbox_emails DROP CONSTRAINT IF EXISTS outbox_emails_imported_email_id_foreign;
ALTER TABLE IF EXISTS ONLY public.outbox_emails DROP CONSTRAINT IF EXISTS outbox_emails_created_by_foreign;
ALTER TABLE IF EXISTS ONLY public.outbox_attachments DROP CONSTRAINT IF EXISTS outbox_attachments_outbox_email_id_foreign;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_spam_marked_by_foreign;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_reference_code_id_foreign;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_gmail_group_id_foreign;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_assigned_to_foreign;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_assigned_by_foreign;
ALTER TABLE IF EXISTS ONLY public.gmail_metadata DROP CONSTRAINT IF EXISTS gmail_metadata_communication_id_foreign;
ALTER TABLE IF EXISTS ONLY public.gmail_groups DROP CONSTRAINT IF EXISTS gmail_groups_assigned_user_id_foreign;
ALTER TABLE IF EXISTS ONLY public.email_campaigns DROP CONSTRAINT IF EXISTS email_campaigns_created_by_foreign;
ALTER TABLE IF EXISTS ONLY public.email_attachments DROP CONSTRAINT IF EXISTS email_attachments_imported_email_id_foreign;
ALTER TABLE IF EXISTS ONLY public.contact_lists DROP CONSTRAINT IF EXISTS contact_lists_created_by_foreign;
ALTER TABLE IF EXISTS ONLY public.contact_list_members DROP CONSTRAINT IF EXISTS contact_list_members_contact_list_id_foreign;
ALTER TABLE IF EXISTS ONLY public.contact_list_members DROP CONSTRAINT IF EXISTS contact_list_members_contact_id_foreign;
ALTER TABLE IF EXISTS ONLY public.communications DROP CONSTRAINT IF EXISTS communications_processed_by_foreign;
ALTER TABLE IF EXISTS ONLY public.communications DROP CONSTRAINT IF EXISTS communications_in_reply_to_foreign;
ALTER TABLE IF EXISTS ONLY public.communications DROP CONSTRAINT IF EXISTS communications_case_id_foreign;
ALTER TABLE IF EXISTS ONLY public.cases DROP CONSTRAINT IF EXISTS cases_assigned_to_foreign;
ALTER TABLE IF EXISTS ONLY public.cases DROP CONSTRAINT IF EXISTS cases_assigned_by_foreign;
ALTER TABLE IF EXISTS ONLY public.case_metrics DROP CONSTRAINT IF EXISTS case_metrics_case_id_foreign;
ALTER TABLE IF EXISTS ONLY public.campaign_sends DROP CONSTRAINT IF EXISTS campaign_sends_contact_id_foreign;
ALTER TABLE IF EXISTS ONLY public.campaign_sends DROP CONSTRAINT IF EXISTS campaign_sends_campaign_id_foreign;
DROP INDEX IF EXISTS public.users_nickname_index;
DROP INDEX IF EXISTS public.user_roles_user_id_index;
DROP INDEX IF EXISTS public.system_config_key_index;
DROP INDEX IF EXISTS public.sessions_user_id_index;
DROP INDEX IF EXISTS public.sessions_last_activity_index;
DROP INDEX IF EXISTS public.reference_codes_usage_count_index;
DROP INDEX IF EXISTS public.reference_codes_last_used_at_index;
DROP INDEX IF EXISTS public.reference_codes_code_hash_index;
DROP INDEX IF EXISTS public.reference_codes_channel_type_index;
DROP INDEX IF EXISTS public.reference_codes_case_id_index;
DROP INDEX IF EXISTS public.reference_codes_assigned_user_id_index;
DROP INDEX IF EXISTS public.phone_communications_phone_number_index;
DROP INDEX IF EXISTS public.phone_communications_follow_up_required_index;
DROP INDEX IF EXISTS public.phone_communications_follow_up_date_index;
DROP INDEX IF EXISTS public.phone_communications_communication_id_index;
DROP INDEX IF EXISTS public.phone_communications_call_type_index;
DROP INDEX IF EXISTS public.phone_communications_call_status_index;
DROP INDEX IF EXISTS public.outbox_emails_send_status_index;
DROP INDEX IF EXISTS public.outbox_emails_scheduled_at_index;
DROP INDEX IF EXISTS public.outbox_emails_imported_email_id_index;
DROP INDEX IF EXISTS public.outbox_emails_created_by_index;
DROP INDEX IF EXISTS public.outbox_attachments_outbox_email_id_index;
DROP INDEX IF EXISTS public.oauth_tokens_provider_is_active_index;
DROP INDEX IF EXISTS public.oauth_tokens_provider_identifier_index;
DROP INDEX IF EXISTS public.jobs_queue_index;
DROP INDEX IF EXISTS public.imported_emails_to_email_index;
DROP INDEX IF EXISTS public.imported_emails_rut_empleador_dv_empleador_index;
DROP INDEX IF EXISTS public.imported_emails_received_at_index;
DROP INDEX IF EXISTS public.imported_emails_imported_at_index;
DROP INDEX IF EXISTS public.imported_emails_gmail_thread_id_index;
DROP INDEX IF EXISTS public.imported_emails_gmail_message_id_index;
DROP INDEX IF EXISTS public.imported_emails_case_status_index;
DROP INDEX IF EXISTS public.imported_emails_assigned_to_index;
DROP INDEX IF EXISTS public.gmail_metadata_sync_status_index;
DROP INDEX IF EXISTS public.gmail_metadata_last_sync_at_index;
DROP INDEX IF EXISTS public.gmail_metadata_is_backed_up_index;
DROP INDEX IF EXISTS public.gmail_metadata_gmail_thread_id_index;
DROP INDEX IF EXISTS public.gmail_metadata_gmail_message_id_index;
DROP INDEX IF EXISTS public.gmail_metadata_communication_id_index;
DROP INDEX IF EXISTS public.gmail_groups_is_active_is_generic_index;
DROP INDEX IF EXISTS public.email_campaigns_status_scheduled_at_index;
DROP INDEX IF EXISTS public.email_campaigns_created_by_index;
DROP INDEX IF EXISTS public.email_attachments_imported_email_id_index;
DROP INDEX IF EXISTS public.contacts_rut_empleador_dv_empleador_producto_index;
DROP INDEX IF EXISTS public.contacts_is_active_index;
DROP INDEX IF EXISTS public.contacts_email_index;
DROP INDEX IF EXISTS public.contact_lists_created_by_index;
DROP INDEX IF EXISTS public.contact_list_members_contact_list_id_index;
DROP INDEX IF EXISTS public.communications_thread_id_index;
DROP INDEX IF EXISTS public.communications_status_index;
DROP INDEX IF EXISTS public.communications_sent_at_index;
DROP INDEX IF EXISTS public.communications_reference_code_index;
DROP INDEX IF EXISTS public.communications_received_at_index;
DROP INDEX IF EXISTS public.communications_external_id_index;
DROP INDEX IF EXISTS public.communications_direction_index;
DROP INDEX IF EXISTS public.communications_channel_type_index;
DROP INDEX IF EXISTS public.communications_case_id_received_at_index;
DROP INDEX IF EXISTS public.communications_case_id_index;
DROP INDEX IF EXISTS public.communications_case_id_channel_type_index;
DROP INDEX IF EXISTS public.cases_status_index;
DROP INDEX IF EXISTS public.cases_priority_index;
DROP INDEX IF EXISTS public.cases_origin_channel_index;
DROP INDEX IF EXISTS public.cases_last_activity_at_index;
DROP INDEX IF EXISTS public.cases_employer_rut_employer_dv_index;
DROP INDEX IF EXISTS public.cases_created_at_index;
DROP INDEX IF EXISTS public.cases_case_number_index;
DROP INDEX IF EXISTS public.cases_assigned_to_index;
DROP INDEX IF EXISTS public.cases_assigned_at_index;
DROP INDEX IF EXISTS public.case_metrics_updated_at_index;
DROP INDEX IF EXISTS public.case_metrics_sla_breach_index;
DROP INDEX IF EXISTS public.case_metrics_satisfaction_score_index;
DROP INDEX IF EXISTS public.case_metrics_preferred_channel_index;
DROP INDEX IF EXISTS public.case_metrics_case_id_index;
DROP INDEX IF EXISTS public.campaign_sends_sent_at_index;
DROP INDEX IF EXISTS public.campaign_sends_send_status_index;
DROP INDEX IF EXISTS public.campaign_sends_campaign_id_contact_id_index;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_email_unique;
ALTER TABLE IF EXISTS ONLY public.user_roles DROP CONSTRAINT IF EXISTS user_roles_user_id_role_unique;
ALTER TABLE IF EXISTS ONLY public.user_roles DROP CONSTRAINT IF EXISTS user_roles_pkey;
ALTER TABLE IF EXISTS ONLY public.system_config DROP CONSTRAINT IF EXISTS system_config_pkey;
ALTER TABLE IF EXISTS ONLY public.system_config DROP CONSTRAINT IF EXISTS system_config_key_unique;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.reference_codes DROP CONSTRAINT IF EXISTS reference_codes_rut_empleador_dv_empleador_producto_unique;
ALTER TABLE IF EXISTS ONLY public.reference_codes DROP CONSTRAINT IF EXISTS reference_codes_pkey;
ALTER TABLE IF EXISTS ONLY public.reference_codes DROP CONSTRAINT IF EXISTS reference_codes_code_hash_unique;
ALTER TABLE IF EXISTS ONLY public.phone_communications DROP CONSTRAINT IF EXISTS phone_communications_pkey;
ALTER TABLE IF EXISTS ONLY public.phone_communications DROP CONSTRAINT IF EXISTS phone_communications_communication_id_unique;
ALTER TABLE IF EXISTS ONLY public.password_reset_tokens DROP CONSTRAINT IF EXISTS password_reset_tokens_pkey;
ALTER TABLE IF EXISTS ONLY public.outbox_emails DROP CONSTRAINT IF EXISTS outbox_emails_pkey;
ALTER TABLE IF EXISTS ONLY public.outbox_attachments DROP CONSTRAINT IF EXISTS outbox_attachments_pkey;
ALTER TABLE IF EXISTS ONLY public.oauth_tokens DROP CONSTRAINT IF EXISTS oauth_tokens_pkey;
ALTER TABLE IF EXISTS ONLY public.oauth_tokens DROP CONSTRAINT IF EXISTS oauth_provider_identifier_unique;
ALTER TABLE IF EXISTS ONLY public.migrations DROP CONSTRAINT IF EXISTS migrations_pkey;
ALTER TABLE IF EXISTS ONLY public.jobs DROP CONSTRAINT IF EXISTS jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.job_batches DROP CONSTRAINT IF EXISTS job_batches_pkey;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_pkey;
ALTER TABLE IF EXISTS ONLY public.imported_emails DROP CONSTRAINT IF EXISTS imported_emails_gmail_message_id_unique;
ALTER TABLE IF EXISTS ONLY public.gmail_metadata DROP CONSTRAINT IF EXISTS gmail_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.gmail_metadata DROP CONSTRAINT IF EXISTS gmail_metadata_gmail_message_id_unique;
ALTER TABLE IF EXISTS ONLY public.gmail_metadata DROP CONSTRAINT IF EXISTS gmail_metadata_communication_id_unique;
ALTER TABLE IF EXISTS ONLY public.gmail_groups DROP CONSTRAINT IF EXISTS gmail_groups_pkey;
ALTER TABLE IF EXISTS ONLY public.gmail_groups DROP CONSTRAINT IF EXISTS gmail_groups_email_unique;
...
ALTER TABLE IF EXISTS ONLY public.email_attachments DROP CONSTRAINT IF EXISTS email_attachments_pkey;
ALTER TABLE IF EXISTS ONLY public.contacts DROP CONSTRAINT IF EXISTS contacts_pkey;
ALTER TABLE IF EXISTS ONLY public.contacts DROP CONSTRAINT IF EXISTS contacts_email_unique;
ALTER TABLE IF EXISTS ONLY public.contact_lists DROP CONSTRAINT IF EXISTS contact_lists_pkey;
ALTER TABLE IF EXISTS ONLY public.contact_list_members DROP CONSTRAINT IF EXISTS contact_list_members_pkey;
ALTER TABLE IF EXISTS ONLY public.contact_list_members DROP CONSTRAINT IF EXISTS contact_list_members_contact_id_contact_list_id_unique;
...
ALTER TABLE IF EXISTS ONLY public.cases DROP CONSTRAINT IF EXISTS cases_case_number_unique;
ALTER TABLE IF EXISTS ONLY public.case_metrics DROP CONSTRAINT IF EXISTS case_metrics_pkey;
ALTER TABLE IF EXISTS ONLY public.case_metrics DROP CONSTRAINT IF EXISTS case_metrics_case_id_unique;
...
ALTER TABLE IF EXISTS public.reference_codes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.phone_communications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.outbox_emails ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.outbox_attachments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.oauth_tokens ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.migrations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.jobs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.imported_emails ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.gmail_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.gmail_groups ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.email_attachments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.contacts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.contact_lists ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.contact_list_members ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.case_metrics ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.reference_codes_id_seq;
DROP TABLE IF EXISTS public.reference_codes;
DROP SEQUENCE IF EXISTS public.phone_communications_id_seq;
DROP TABLE IF EXISTS public.phone_communications;
DROP TABLE IF EXISTS public.password_reset_tokens;
DROP SEQUENCE IF EXISTS public.outbox_emails_id_seq;
DROP TABLE IF EXISTS public.outbox_emails;
DROP SEQUENCE IF EXISTS public.outbox_attachments_id_seq;
DROP TABLE IF EXISTS public.outbox_attachments;
DROP SEQUENCE IF EXISTS public.oauth_tokens_id_seq;
...
DROP SEQUENCE IF EXISTS public.imported_emails_id_seq;
DROP TABLE IF EXISTS public.imported_emails;
DROP SEQUENCE IF EXISTS public.gmail_metadata_id_seq;
DROP TABLE IF EXISTS public.gmail_metadata;
DROP SEQUENCE IF EXISTS public.gmail_groups_id_seq;
DROP TABLE IF EXISTS public.gmail_groups;
...
DROP SEQUENCE IF EXISTS public.contact_lists_id_seq;
DROP TABLE IF EXISTS public.contact_lists;
DROP SEQUENCE IF EXISTS public.contact_list_members_id_seq;
...
DROP SEQUENCE IF EXISTS public.case_metrics_id_seq;
DROP TABLE IF EXISTS public.case_metrics;
...
\unrestrict UbaeMbvZcEm1tYrDv6Qv42ttebsuP1lD0QbCTcHngMyXofoutrmMPxTUGn2vod4
